...
- **Global scope**: `/Users/yi-tingli/Documents/Projects/ml_topic_contrastive_learning/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/yi-tingli/Documents/Projects/ml_topic_contrastive_learning/.claude/notes/`)
...
2. Glob `/Users/yi-tingli/Documents/Projects/ml_topic_contrastive_learning/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/yi-tingli/Documents/Projects/ml_topic_contrastive_learning/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/yi-tingli/Documents/Projects/ml_topic_contrastive_learning/.claude/notes/` — works in any directory
